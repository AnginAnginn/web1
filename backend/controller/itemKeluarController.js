const Item = require ("../models/itemKeluarModel");
...
const getItemId2 = async (req, res) => {
...
const updateItem2 = async (req, res) => {
    try {
        ...
        // Masukkan nilai keuntungan baru ke dalam data yang akan diperbarui
...
module.exports = {getItem2, getItemId2, postItem2, updateItem2, deleteItem2 }